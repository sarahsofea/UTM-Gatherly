...
CREATE TABLE reviews (
    ...
    rating INT NOT NULL,                      -- Rating out of 5 stars
    heard_from VARCHAR(100),                  -- How the participant heard about the event
    enjoyed TEXT,                             -- What the participant enjoyed (comma-separated values)
    join_again ENUM('Yes', 'No') NOT NULL,    -- Would they join again?
    reason TEXT,                              -- Reason if they won't join again
...
-- Inserting sample data into the updated reviews table
INSERT INTO reviews (event_id, participant_name, review_text, rating, heard_from, enjoyed, join_again, reason) VALUES
(1, 'Alice Johnson', 'It was a great experience! The beach looks so much cleaner now.', 5, 'Social Media', 'Venue,Activities', 'Yes', NULL),
(1, 'Bob Smith', 'Loved being part of the cleanup. Will definitely join again next year!', 4, 'Friend', 'Venue,Networking', 'Yes', NULL),
(2, 'Charlie Brown', 'Fantastic music and a lively atmosphere! Really enjoyed it.', 5, 'UTM Gatherly', 'Activities,Networking', 'Yes', NULL),
(2, 'Daisy Miller', 'The food trucks were amazing! Great selection of food.', 4, 'Social Media', 'Experiences', 'Yes', NULL),
(3, 'Eva Green', 'A beautiful day spent in the park with wonderful art.', 5, 'Social Media', 'Experiences', 'Yes', NULL),
(4, 'Frank White', 'Such a calming yoga session. I feel refreshed!', 5, 'Friend', 'Venue,Activities', 'Yes', NULL),
(5, 'Grace Lee', 'The festival was delightful. I loved the local produce stalls.', 4, 'Other', 'Venue,Networking', 'Yes', NULL),
(6, 'Hank Turner', 'The ice skating was magical! A wonderful way to celebrate the season.', 5, 'UTM Gatherly', 'Activities,Experiences', 'Yes', NULL),
(3, 'John Doe', 'The event was okay, but the parking situation was terrible.', 3, 'Other', 'Venue', 'No', 'Parking issues'),
(4, 'Jane Smith', 'Yoga was good, but I felt it was too crowded.', 3, 'Friend', 'Activities', 'No', 'Overcrowded event');
